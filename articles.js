...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function checkForKeywords(content) {
        var keywords = ["sex", "education", "sexual health", "reproductive health", "contraception", "pregnancy", "std", "stds", "sexually transmitted disease", "sexually transmitted diseases"];
